...
legend('f(t)', 'location', location, 'fontsize', cww_dflt.font_size)

if do_save
    fname = 'compare_met_true_func';
...
plot(t1,f(t1), 'color', gray_color, 'linewidth', cww_dflt.line_width);
hold('on');

plot(t1,x_gs, 'color', 'k', 'linewidth', cww_dflt.line_width);
...
plot(t1, walsh_approx_pbdw, 'color', 'k', 'linewidth', cww_dflt.line_width);
...
plot(t1,x_cs, 'color', 'k', 'linewidth', cww_dflt.line_width);
