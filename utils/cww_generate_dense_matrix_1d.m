% Computes a dense version of the matrix P_N U P_M, where U is the one dimensional 
% change-of-basis matrix between a Walsh basis and an orthonormal wavelet basis.
% The dense representation is computed using repeated calls to `cww_handle_1d`.
%
% Arguments
% ---------
...
%
function X = cww_generate_full_matrix_1d(log2N, log2M, wname, bd_mode, j0)
    ...
    G = @(x,mode) cww_handle_1d(x, mode, log2N, log2M, wname, bd_mode, j0, phi_walsh_pieces); 
